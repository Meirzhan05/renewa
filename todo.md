...
- [ ] Replace the local Inbox agent worker with a deployed managed workflow runtime that can fairly process concurrent App Store users, recover interrupted work, and keep credentials out of task payloads.
