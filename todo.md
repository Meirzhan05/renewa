...
- [x] Add opt-in onboarding inbox discovery and daily cursor-based monitoring infrastructure; configure the protected Supabase scheduler before enabling it in production.
